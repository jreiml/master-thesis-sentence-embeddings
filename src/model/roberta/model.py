...
from transformers import RobertaPreTrainedModel, RobertaModel, RobertaForMaskedLM
...
class RobertaForContrastiveCrossBiEncoder(RobertaPreTrainedModel):
...
class RobertaForEmbeddingSimilarityCrossBiEncoder(RobertaPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
...
class RobertaForFixedMaskedLM(RobertaForMaskedLM):
    pass


class RobertaForSentenceEmbeddingClassification(RobertaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
