...
from transformers import XLMRobertaPreTrainedModel, XLMRobertaModel, XLMRobertaForMaskedLM
...
class XLMRobertaForContrastiveCrossBiEncoder(XLMRobertaPreTrainedModel):
...
class XLMRobertaForEmbeddingSimilarityCrossBiEncoder(XLMRobertaPreTrainedModel):
    _keys_to_ignore_on_load_missing = [r"position_ids"]
...
class XLMRobertaForFixedMaskedLM(XLMRobertaForMaskedLM):
    pass


class XLMRobertaForSentenceEmbeddingClassification(XLMRobertaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
