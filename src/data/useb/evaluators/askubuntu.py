...
class AskubuntuEvaluator(BaseEvaluator, AskUbuntuData):
    ...
    def __init__(self, semb_fn, datasets_dir='datasets/usep/data-eval/askubuntu', text_components='title', bsz=32, show=True):
    ...
    def _run(self, eval_type):
        ...
        result = {}
        show = bool(self.show)
        for eval_example in tqdm(eval_set, disable=not self.show):
            ...
            embs = self._text2se(sents, normalize=True)  # (bsz, hdim) = (1+20, hdim)
